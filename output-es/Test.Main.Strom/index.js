...
import * as Yoga$dOm$dStrom$dTest from "../Yoga.Om.Strom.Test/index.js";
const main = /* #__PURE__ */ (() => {
  const $0 = Effect$dAff._makeFiber(
    Effect$dAff.ffiUtil,
    Effect$dAff._map(v => {})(Test$dSpec$dRunner.runSpecT1(Test$dSpec$dConfig.defaultConfig)([Test$dSpec$dReporter$dConsole.consoleReporter])(Yoga$dOm$dStrom$dTest.spec))
  );
  return () => {
    const fiber = $0();
    fiber.run();
