...
import * as Yoga$dOm$dNode$dTest from "../Yoga.Om.Node.Test/index.js";
const main = /* #__PURE__ */ (() => {
  const $0 = Effect$dAff._makeFiber(
    Effect$dAff.ffiUtil,
    Effect$dAff._map(v => {})(Test$dSpec$dRunner.runSpecT1(Test$dSpec$dConfig.defaultConfig)([Test$dSpec$dReporter$dConsole.consoleReporter])(Yoga$dOm$dNode$dTest.spec))
  );
  return () => {
    const fiber = $0();
    fiber.run();
