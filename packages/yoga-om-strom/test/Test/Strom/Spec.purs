  ...
  describe "Strom" do
    ...
    describe "Grouping" do
      ...
      it "grouped creates fixed-size chunks" do
        result <- runOm $
          Strom.rangeStrom 1 11
            # Strom.mapStrom (\x -> [ x ]) -- TODO: grouped 3
            # Strom.runCollect
      ...
      it "chunked is alias for grouped" do
        result <- runOm $
          Strom.rangeStrom 1 6
            # Strom.mapStrom (\x -> [ x ]) -- TODO: chunked 2
            # Strom.runCollect
        result `shouldEqual` [ [ 1, 2 ], [ 3, 4 ], [ 5 ] ]
    ...
    describe "Error Handling" do
      ...
      -- TODO: catchAll not yet implemented, skipping this test
      ...
      it "large stream with take" do
        result <- runOm $
          Strom.iterateStrom (_ + 1) 0
            # Strom.filterStrom (\n -> n `mod` 3 == 0)
            # Strom.takeStrom 100
            # Strom.mapStrom (\x -> [ x ]) -- TODO: grouped 10
            # Strom.runCollect
    ...
    describe "Edge Cases" do
      ...
      it "grouped with size larger than stream" do
        result <- runOm $
          Strom.fromArray [ 1, 2, 3 ]
            # Strom.mapStrom (\x -> [ x ]) -- TODO: grouped 100
            # Strom.runCollect
        result `shouldEqual` [ [ 1, 2, 3 ] ]
